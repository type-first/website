...
import { getDocPageBySlug, getDocBreadcrumbs, buildDocNavigation, type DocPageMeta } from '@/lib/content/doc.model';
...
interface TypistPageLayoutProps {
  pageSlug: string;
  children: ReactNode;
}

export function TypistPageLayout({ pageSlug, children }: TypistPageLayoutProps) {
  ...
  const page = getDocPageBySlug(library, pageSlug);
