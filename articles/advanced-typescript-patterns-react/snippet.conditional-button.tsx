...
export const ConditionalButtonCode: MultiModalComponent<ConditionalButtonCodeProps> = multimodal<ConditionalButtonCodeProps>()(({ modality, filename }) => (
  <Code language="typescript" filename={filename || "components/ConditionalButton.tsx"} modality={modality}>
