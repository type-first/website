...
export const articleMetadata = {
  ...
  tags: [ARTICLE_TAGS.AI, ARTICLE_TAGS.DATABASE, ARTICLE_TAGS.DATABASE, "embeddings", "search"],
  publishedAt: new Date("2024-02-18T12:00:00Z"),
  updatedAt: new Date("2024-02-18T12:00:00Z"),
  seoTitle: "RAG 101: Building a Retrieval Layer with Postgres + pgvector",
  seoDescription: "From plaintext to embeddings: build a pragmatic retrieval layer with Postgres and pgvector.",
  author: "Your Name",
  coverImage: "/images/covers/rag-101-postgres-pgvector.png",
};
...
export default function Rag101PostgresPgvectorPage() {
  const jsonLd = {
    ...
    <>
      ...
      <article className="max-w-4xl mx-auto px-6 py-12">
        ...
        <div className="mb-12">
          ...
          <h2 className="text-3xl font-bold text-gray-900 mb-6 mt-12">Content Derivation</h2>

          <p className="text-gray-700 leading-relaxed mb-6">
            Start by deriving plaintext and outlines from your sources. Keep the pipeline deterministic and resumable.
          </p>

          <h2 className="text-3xl font-bold text-gray-900 mb-6 mt-12">Embeddings</h2>
